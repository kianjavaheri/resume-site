    ...
    <div>
        ...
        <section className="courses-container">
            <div className="course-list">
                <a href="https://apcentral.collegeboard.org/courses/ap-computer-science-a" target="_blank" rel="noopener noreferrer">AP Computer Science (CSE 110: Principles of Programming)</a>
                <br/>
                <br/>
